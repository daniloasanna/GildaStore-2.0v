...
public class Api2 {
    private static final String ROOT_URL = "https://sitezasso.000webhostapp.com/gildastore/produto/v1/Api.php?apicall=";
    ...
    public static final String URL_DELETE_GILDAAPP = ROOT_URL + "deletegildaapp&idProduto=";
}
